        ...
        <?php foreach($items as $item){ ?>
			...
			<div class="content_list_item <?php echo $ctype['name']; ?>_list_item<?php if (!empty($item['is_vip'])){ ?> is_vip<?php } ?>">
                        ...
                        <?php } else { ?>
                            <div class="value">
                                ...
                                <?php } else { ?>
                                    <?php echo $field['html']; ?>
                                <?php } ?>
                                <?php if ($field['name'] == 'teaser') { ?>
                                    <div id="full_link">
                                        <a href="<?php echo href_to($ctype['name'], $item['slug'].'.html'); ?>">Читать полностью</a>
                                    </div>
                                <?php } ?>
                            </div>
                        <?php } ?>
                ...
                <?php if (!empty($item['show_tags'])){ ?>
                    <div class="tags_bar">
                        Теги: <?php echo html_tags_bar($item['tags'], 'content-'.$ctype['name']); ?>
                    </div>
                <?php } ?>
                        ...
                        <?php foreach($item['info_bar'] as $bar){ ?>
                            <div class="bar_item <?php echo !empty($bar['css']) ? $bar['css'] : ''; ?>" title="<?php html(!empty($bar['title']) ? $bar['title'] : ''); ?>">
                                <?php if (!empty($bar['href'])){ ?>
                                    <a href="<?php echo $bar['href']; ?>"><?php html(!empty($bar['title']) ? $bar['title'] : ''); ?>:&nbsp;<?php echo $bar['html']; ?></a>
                                <?php } else { ?>
                                    <?php echo $bar['html']; ?>
                                <?php } ?>
                            </div>
